...
docker pull 014498660251.dkr.ecr.us-east-1.amazonaws.com/myapp-repo:$APP_VERSION
docker run -d -p 8000:8000 014498660251.dkr.ecr.us-east-1.amazonaws.com/myapp-repo:$APP_VERSION
